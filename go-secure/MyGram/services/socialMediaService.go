...
type SocialMediaService interface {
	...
	Create(ctx context.Context, socialMedia model.SocialMedia, userID uint) (model.SocialMedia, error)
	Update(ctx context.Context, socialMedia model.SocialMedia, id, userID uint) (model.SocialMedia, error)
