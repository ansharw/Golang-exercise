...
type RequestPhoto struct {
	Title    string `gorm:"-:all" json:"title" form:"title" binding:"required" validate:"required"`
	Caption  string `gorm:"-:all" json:"caption,omitempty" form:"caption,omitempty"`
	PhotoURL string `gorm:"-:all" json:"photo_url" form:"photo_url" binding:"required" validate:"required,url"`
}